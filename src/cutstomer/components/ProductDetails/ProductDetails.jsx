        ...
        <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
                ...
                <p className="opacity-50 text-sm"> RS 564251 </p>
                <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500"> 3870 Reaview </p>
                </div>
            ...
            <form className="mt-10">
              ...
              <Button onClick={handleAddtoCart} color='secondary' varient="contained " sx={{px:"2rem " , py:"1rem"}}>
                Add to Cart 
              </Button>
            </form>
          </div>
                ...
                <div className='border p-5 '>
                  <Grid container  spacing ={9}>
                    ...
                    <div className='flex item-center space-x-3'>
                      ...
                      <p className='opacity-60'>599988 Ratings </p>
                    </div>
                    ...
                    <p>Excellent</p>
                      ...
                      <Grid item xs={7}>
                     <LinearProgress
          sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7, width: '100%' }}
          variant='determinate'
          value={70}
          color='success'
        />
                    ...
                    <p> Very Good </p>
                      ...
                      <Grid item xs={7}>
                     <LinearProgress
          sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7, width: '100%',color:"yellow" }}
          variant='determinate'
          value={50}
          color='success'
        />
